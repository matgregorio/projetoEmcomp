...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="linha">
            <?php
            $result_produto = "SELECT * FROM produto WHERE seguimento_prod = 'anos70';";
            $resultado_produto = mysqli_query($link, $result_produto);
            ?>
            <section>
<?php while ($row_result_produto = mysqli_fetch_assoc($resultado_produto)) { ?>  
                    <div class="coluna col3">
                        <img src="./img/<?php echo $row_result_produto['arquivo_prod']; ?>" width=200px heigth=200px alt="<?php echo $row_result_produto['arquivo_prod']; ?>"/>
                        <h3><?php echo $row_result_produto['nome_prod']; ?></h3>
